...
#[inline]
pub unsafe fn l4_factory_create_task(
    factory: l4_cap_idx_t,
    target_cap: &mut l4_cap_idx_t,
...
#[inline]
pub unsafe fn l4_factory_create_task_u(
    factory: l4_cap_idx_t,
    target_cap: &mut l4_cap_idx_t,
    utcb_area: l4_fpage_t,
    u: *mut l4_utcb_t,
) -> l4_msgtag_t {
    let mut tag = l4_factory_create_start_u(MsgTagProto::L4_PROTO_TASK as i32, *target_cap, u);
...
#[inline]
pub fn l4_factory_create_thread(factory: l4_cap_idx_t, target_cap: l4_cap_idx_t) -> l4_msgtag_t {
    ...
    unsafe { l4_factory_create_thread_u(factory, target_cap, l4_utcb()) }
}

#[inline]
pub unsafe fn l4_factory_create_thread_u(
    factory: l4_cap_idx_t,
    target_cap: l4_cap_idx_t,
    u: *mut l4_utcb_t,
) -> l4_msgtag_t {
    l4_factory_create_u(factory, MsgTagProto::L4_PROTO_THREAD as i32, target_cap, u)
}
...
#[inline]
pub unsafe fn l4_factory_create_factory(
    factory: l4_cap_idx_t,
    target_cap: l4_cap_idx_t,
    limit: u64,
) -> l4_msgtag_t {
...
#[inline]
pub unsafe fn l4_factory_create_factory_u(
    factory: l4_cap_idx_t,
    target_cap: l4_cap_idx_t,
    limit: u64,
    u: *mut l4_utcb_t,
) -> l4_msgtag_t {
    let mut tag = l4_factory_create_start_u(MsgTagProto::L4_PROTO_FACTORY as i32, target_cap, u);
...
#[inline]
pub unsafe fn l4_factory_create_gate(
    factory: l4_cap_idx_t,
    target_cap: l4_cap_idx_t,
...
#[inline]
pub unsafe fn l4_factory_create_gate_u(
    factory: l4_cap_idx_t,
    target_cap: l4_cap_idx_t,
    thread_cap: l4_cap_idx_t,
    label: l4_umword_t,
    ...
    if (thread_cap & l4_cap_consts_t::L4_INVALID_CAP_BIT as u64) == 0 {
        ...
        mr!(v[4] = cap::l4_obj_fpage(thread_cap, 0, L4_fpage_rights::L4_FPAGE_RWX as u8).raw);
    }
    tag = msgtag(
        msgtag_label(tag),
        msgtag_words(tag),
...
// ToDo: docs
#[inline]
pub fn l4_factory_create_add_int_u(
    d: l4_mword_t,
    tag: &mut l4_msgtag_t,
    u: *mut l4_utcb_t,
) -> bool {
    ...
    unsafe {
        let v = l4_utcb_mr_u(u);
        mr!(v[w] = L4_varg_type::L4_VARG_TYPE_MWORD as u64 | (size_of::<l4_mword_t>() << 16) as u64);
        mr!(v[w + 1] = d);
    }
    w += 2;
...
#[inline]
pub fn l4_factory_create_add_uint_u(
    d: l4_umword_t,
    tag: &mut l4_msgtag_t,
    u: *mut l4_utcb_t,
) -> bool {
    ...
    unsafe {
        let v = l4_utcb_mr_u(u);
        mr!(v[w] =
            L4_varg_type::L4_VARG_TYPE_UMWORD as u64 | (size_of::<l4_umword_t>() << 16) as u64);
        mr!(v[w + 1] = d);
    }
    w += 2;
...
#[inline]
pub unsafe fn l4_factory_create_add_cstr_u(
    s: *const u8,
    tag: &mut l4_msgtag_t,
    u: *mut l4_utcb_t,
) -> bool {
    let mut w = msgtag_words(*tag) as usize;
    let len = core_ffi_helpers::strlen(s) as usize;
...
#[inline]
pub fn l4_factory_create_add_str_u(s: &str, tag: &mut l4_msgtag_t, u: *mut l4_utcb_t) -> bool {
    let mut w = msgtag_words(*tag);
    let len = s.len();
    ...
    w = w + 1 + ((len + size_of::<l4_umword_t>() - 1) / size_of::<l4_umword_t>()) as u32;
    tag.raw = (tag.raw & !0x3f) | (w as i64 & 0x3f);
    true
}

#[inline]
pub unsafe fn l4_factory_create_commit_u(
    factory: l4_cap_idx_t,
    tag: l4_msgtag_t,
    u: *mut l4_utcb_t,
) -> l4_msgtag_t {
...
#[inline]
pub unsafe fn l4_factory_create_u(
    factory: l4_cap_idx_t,
    protocol: i32,
    target: l4_cap_idx_t,
    utcb: *mut l4_utcb_t,
...
#[inline]
unsafe fn l4_factory_create_start_u(
    protocol: i32,
    target_cap: l4_cap_idx_t,
    u: *mut l4_utcb_t,
) -> l4_msgtag_t {
...
pub fn l4_factory_create_add_fpage_u(
    d: l4_fpage_t,
    tag: &mut l4_msgtag_t,
    u: *mut l4_utcb_t,
) -> bool {
...
#[inline]
pub unsafe fn l4_factory_create_add_nil_u(tag: &mut l4_msgtag_t, u: *mut l4_utcb_t) -> bool {
    let mut w = msgtag_words(*tag);
